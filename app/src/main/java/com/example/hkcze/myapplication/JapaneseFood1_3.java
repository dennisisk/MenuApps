...
public class JapaneseFood1_3 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_japanese_food1_3, container, false);
    ...
    public void changetextsize (View v) {
        npt= getActivity().findViewById(R.id.nextpage3);
        if (count == 0) {
            npt.setTextSize(35);
            count++;
        }
