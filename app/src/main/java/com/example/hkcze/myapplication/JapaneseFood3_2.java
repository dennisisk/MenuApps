...
public class JapaneseFood3_2 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_japanese_food3_2, container, false);
    ...
    public void changetextsize (View v) {
        npt= getActivity().findViewById(R.id.nextpage2);
        if (count == 0) {
            npt.setTextSize(35);
            count++;
        }
